...
Sets are used for operations involving frequent intersection,
...
#Finding Union
#To find the unique values of two
#  arrays, use the union1d() method.
...
#To find only the values that are present
#  in both arrays, use the intersect1d() method.
#optional argument assume_unique, which if set to True can 
# speed up computation. It should always be set to True when
#  dealing with sets.
